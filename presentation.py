...
def show_results():
    ...
    results_df = pd.DataFrame({
        ...
        "Accuracy": [0.9675, 0.9850, 0.9885, 0.9665],
        "Precision": [0.6000, 0.8800, 0.9245, 1.0000],
        "Recall": [0.1324, 0.6471, 0.7206, 0.0147],
        "F1": [0.2169, 0.7458, 0.8099, 0.0290],
        "ROC AUC": [0.9006, 0.9644, 0.9746, 0.8926]
    })
...
def show_conclusion():
    ...
    1. [Репозиторий проекта на GitHub](https://github.com/RatmirTech/KAI.PrediMaint)
